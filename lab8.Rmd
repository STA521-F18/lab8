---
title: "lab 8: Team [my team #/name here]"
...
We are going to repeat parts of Lab 5 using Ridge Regression and Lasso. 
...
1.  As a team agree on the transformation of the response to use for the lab and fit the full model using OLS for the training data.  Obtain the predictions of `Apps` on the test data and the RMSE.
